    ...
    <header className="header-area">
      <nav
        className={classNames(
          'navbar z-[999] h-16 w-full bg-slate-800 py-4 opacity-100 duration-300 ease-in-out md:fixed md:top-0 md:left-0  md:transition-all',
          atTop ? 'md:bg-slate-50 md:py-4  md:shadow-2xl' : 'md:bg-transparent md:py-10'
        )}
      >
        <div className="container mx-auto max-w-screen-2xl px-4 sm:px-8 lg:px-16 xl:px-20">
          <div className="header-wrapper flex items-center justify-between">
            ...
            <div className="toggle md:hidden">
              <div className="wrapper flex">{mobileNavToggle()}</div>
              <Transition
                show={navbar}
                ...
                {user ? (
                  ...
                  <>
                    ...
                    >
                      <NavLink
                        to="/login"
                        className={classNames(!atTop ? 'text-slate-200' : 'text-slate-800')}
                      >
                        Login
                      </NavLink>
                    </li>
