...
const TermsPolicy = () => {
  useTitle('Terms, Conditions & Privacy Policy')
  return (
    <GuestLayout>
      <main className="bg-primary-gradient min-h-screen w-full py-32 ">
        <h1 className=" text-center text-4xl font-black uppercase text-gray-900 dark:text-gray-50 lg:text-7xl xl:text-8xl xl:leading-snug">
          <span className="bg-gradient-to-r from-pink-500 to-violet-500 bg-clip-text text-transparent ">
            Terms &amp; Conditions
          </span>
        </h1>
        <div className="wrapper mx-auto mt-32 px-6 leading-8 text-slate-300 ">
          <h2 className="text-3xl uppercase text-slate-100">
            <strong>Welcome to SkirmisherAI</strong>
          </h2>
          <p className="mt-4">
            These terms and conditions outline the rules and regulations for the use of Skirmisher
            LLC's Website, located at SkirmisherAI.com.
          </p>
          <p>
            By accessing this website we assume you accept these terms and conditions. Do not
            continue to use SkirmisherAI if you do not agree to take all of the terms and conditions
            stated on this page.
          </p>
          <p className="mt-4">
          ...
          <h3 className="mt-4 text-2xl uppercase text-slate-100">
            <strong>Cookies</strong>
          </h3>
          <p>
            We employ the use of cookies. By accessing SkirmisherAI, you agreed to use cookies in
            agreement with the Skirmisher LLC's Privacy Policy.{' '}
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, Skirmisher LLC and/or its licensors own the intellectual
            property rights for all material on SkirmisherAI. All intellectual property rights are
            reserved. You may access this from SkirmisherAI for your own personal use subjected to
            restrictions set in these terms and conditions.
          </p>
          <p className="font-semibold text-gray-50">You must not:</p>
          <ul className="pl-6">
            <li>Republish material from SkirmisherAI</li>
            <li>Sell, rent or sub-license material from SkirmisherAI</li>
            <li>Reproduce, duplicate or copy material from SkirmisherAI</li>
            <li>Redistribute content from SkirmisherAI</li>
          </ul>
          <p className="mt-4">
            This Agreement shall begin on the date hereof. Our Terms and Conditions were created
            with the help of the Well-known Law-Firm .
          </p>
          <p className="mt-4">
            Parts of this website offer an opportunity for users to post and exchange opinions and
            information in certain areas of the website. Skirmisher LLC does not filter, edit,
            publish or review Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of Skirmisher LLC,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views and opinions. To the
            extent permitted by applicable laws, Skirmisher LLC shall not be liable for the Comments
          ...
          <p className="mt-4">
            Skirmisher LLC reserves the right to monitor all Comments and to remove any Comments
            which can be considered inappropriate, offensive or causes breach of these Terms and
            Conditions.
          </p>
          <p className="font-semibold text-gray-50">You warrant and represent that:</p>
          <ul className="pl-6">
            <li>
          ...
          <p className="mt-4">
            You hereby grant Skirmisher LLC a non-exclusive license to use, reproduce, edit and
          ...
          <p className="mt-4">
            ...
            visibility of the hyperlink compensates the absence of Skirmisher LLC; and (d) the link
          ...
          <p className="mt-4">
            ...
            linking to our website, you must inform us by sending an e-mail to Skirmisher LLC.
          ...
          <p className="mt-4">
            No use of Skirmisher LLC's logo or other artwork will be allowed for linking absent a
