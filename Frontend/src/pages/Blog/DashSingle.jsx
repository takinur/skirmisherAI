...
export const DashSingleBlogPost = () => {
  ...
  const conditionalRender = () => {
    ...
    if (post) {
      return (
        <>
          <ButtonDefault onClick={() => navigate(-1)} className="ml-5 !bg-gray-700 md:mt-2">
  ...
  return (
    <AuthLayout title={'Community Post'}>
      <div className="wrapper mx-auto mb-auto max-w-screen-2xl bg-slate-50 px-20 pt-10 pb-10">
        {conditionalRender()}
      </div>
    </AuthLayout>
  )
