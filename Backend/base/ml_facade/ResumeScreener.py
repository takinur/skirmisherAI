...
class resumeScreener:
    ...
    def screenResume(self, text):
        ...
        tokenizer_path = os.path.join(os.path.dirname(__file__), 'assets/tokenizer/feature_tokenizer.pickle')
        with open(tokenizer_path, 'rb') as handle:
            feature_tokenizer = pickle.load(handle)

        # Get label encoding dictionary from model training
        dic_path = os.path.join(os.path.dirname(__file__), 'assets/dictionary/dictionary.pickle')
        ...
        label_path = os.path.join(os.path.dirname(__file__), 'assets/data/labels.json')
        ...
        predict_padded = tf.keras.utils.pad_sequences(predict_sequences, maxlen=self.max_length, padding=self.padding_type, truncating=self.trunc_type)
