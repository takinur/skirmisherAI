...
class CandidateProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'resume_file', 'user', 'email', 'name', 'phone', 'designation', 'location',
                  'skills', 'website', 'educations', 'experiences', 'socials', 'projects']
        extra_kwargs = {'user': {'write_only': True},
                        'resume_raw_text': {'write_only': True}}
    ...
    def create(self, validated_data):
        ...
        # Save Experince
            Experience.objects.create(
                candidate=candidate, name=exp_data['name'], total=exp_data['total'])
        # Save Social
...
class BlogSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = '__all__'
        look_field = 'slug'
        extra_kwargs = {'url': {'lookup_field': 'slug'}, 'author': {'write_only': True}}
